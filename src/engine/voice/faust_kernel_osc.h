...
// Source: src/engine/voice/osc.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::fx_voice_osc; its
...
namespace daisyapps { namespace fx_voice_osc {
/* ------------------------------------------------------------
name: "osc"
...
#endif
} } // namespace daisyapps::fx_voice_osc
