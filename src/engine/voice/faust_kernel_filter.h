...
// Source: src/engine/voice/filter.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::fx_voice_filter; its
...
namespace daisyapps { namespace fx_voice_filter {
/* ------------------------------------------------------------
name: "filter"
...
#endif
} } // namespace daisyapps::fx_voice_filter
