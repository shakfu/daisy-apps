...
// Source: src/engine/reverb/dattorro.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::rv_dattorro; its
...
namespace daisyapps { namespace rv_dattorro {
/* ------------------------------------------------------------
name: "dattorro"
...
#endif
} } // namespace daisyapps::rv_dattorro
