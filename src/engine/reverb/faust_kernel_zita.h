...
// Source: src/engine/reverb/zita.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::rv_zita; its
...
namespace daisyapps { namespace rv_zita {
/* ------------------------------------------------------------
name: "zita"
