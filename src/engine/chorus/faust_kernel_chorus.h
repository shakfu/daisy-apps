...
// Source: src/engine/chorus/chorus.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::fx_chorus; its
...
namespace daisyapps { namespace fx_chorus {
/* ------------------------------------------------------------
name: "chorus"
