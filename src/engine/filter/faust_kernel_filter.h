...
// Source: src/engine/filter/filter.dsp. The generated `class mydsp` is wrapped in namespace daisyapps::fx_filter; its
...
namespace daisyapps { namespace fx_filter {
/* ------------------------------------------------------------
name: "filter"
