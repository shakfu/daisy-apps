...
# The Daisy port links the repo's vendored libDaisy + DaisySP (via the symlinks below); they live in
# the libs/ submodule tree, so make sure they are checked out.
for d in libs/libDaisy libs/DaisySP; do
...
echo "==> linking Daisy/{libDaisy,DaisySP} -> libs/{libDaisy,DaisySP}"
ln -sfn ../../../libs/libDaisy "$tp/Daisy/libDaisy"
ln -sfn ../../../libs/DaisySP  "$tp/Daisy/DaisySP"
